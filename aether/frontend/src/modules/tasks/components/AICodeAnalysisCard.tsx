                    ...
                    >
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-2 gap-2">
                            <div className="flex items-center gap-2 min-w-0 flex-1">
                                <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-amber-100 dark:bg-amber-900/30 flex items-center justify-center shrink-0">
                                    <CheckCircle2 size={12} className="text-amber-600 dark:text-amber-400 sm:w-[14px] sm:h-[14px]" />
                                </div>
                                <span className="text-[11px] sm:text-xs font-medium text-amber-700 dark:text-amber-400 flex items-center gap-1 truncate">
                                    Scan Complete
                                    {analysis.cached && (
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                            >
                                <Maximize2 size={14} className="text-amber-500 dark:text-amber-400 group-hover:text-amber-700 dark:group-hover:text-amber-300" />
                            </motion.button>
                        </div>
                        ...
                        <div className="p-6 overflow-y-auto premium-scrollbar flex-1 space-y-6">
                            <div className="p-4 bg-amber-50 dark:bg-amber-900/10 rounded-xl border border-amber-100 dark:border-amber-900/30 flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-amber-800 dark:text-amber-200/80 leading-relaxed">{analysis.summary}</p>
                                </div>
                            </div>
